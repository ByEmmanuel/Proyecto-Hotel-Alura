...
public class ErrorRegistroContraseña extends RuntimeException  {

    public ErrorRegistroContraseña() {
    ...
    public ErrorRegistroContraseña(String mensaje){
        super(mensaje);
    }
    ...
    private Label Errormsg() {
        ...
        Errormsg.setText("Contraseña no valida. \n Debes introducir una contraseña mayor a 4 digitos");
